...
angular.module("step.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("step.html",
    "<section ng-show=\"selected\" ng-class=\"{current: selected, done: completed, isChanged: isChanged}\" class=\"step\" ng-transclude>\n" +
    "</section>");
}]);
...
angular.module("wizard.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("wizard.html",
    ...
    "        <li ng-class=\"{default: (!step.completed && !step.selected) || (!step.selected && !step.isChanged),\n" +
    "        current: step.selected && !step.completed,\n" +
    "        done: step.completed && !step.selected && step.isChanged,\n" +
            ...
            function canEnterStep(step) {
                ...
                if (angular.isFunction(canEnter.then)) {
                    ...
                    canEnter.then(function (response) {
                        step.isChanged = response;
                        defer.resolve(response);
                    });
                    return defer.promise;
                } else {
                    step.isChanged = canEnter;
